    ...
    try:
        with open(file_path, "rb") as file:
            ...
            if calculate_md5(data) == "065e467b8789b95859d7d33fd30addeb":
                ...
                print(
                    "Hash verification for the .text segment failed; you cannot modify the text segment."
                )
    except Exception as e:
...
if __name__ == "__main__":
    ...
    print("")
    print(
        "We have modified the .text segment. Please analyze the code and use utility.py to modify the data segment"
    )
    print(
        "in the binary for checking. After completing the repair, execute the binary to obtain the flag."
    )
    while True:
